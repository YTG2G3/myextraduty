                                    ...
                                    <NavigationMenuLink asChild>
                                        ...
                                        >
                                            ...
                                            <p className="text-sm leading-tight text-muted-foreground">
                                                Simplify extra duty organization. Streamline your processes and speed up task allocation with user-friendly platform.
                                            </p>
                                        </Link>
                                    </NavigationMenuLink>
                                </li>
                    ...
                    <NavigationMenuItem>
                        ...
                        <NavigationMenuContent>
                            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                                ...
                                <ListItem href="https://www.erdcloud.com/d/RKYWgfFhHoGsDDfn8" title="Schema">
                                    Database schema on ERDCloud. Only Algorix employees have access.
                                </ListItem>

                                <ListItem href="https://discord.com/invite/Qrspk6GqwJ" title="Discord Server">
...
function ListItem({ title, children, href }: { className?: string; title: string; children: React.ReactNode; href: string }) {
    return (
        <li>
            <NavigationMenuLink asChild>
